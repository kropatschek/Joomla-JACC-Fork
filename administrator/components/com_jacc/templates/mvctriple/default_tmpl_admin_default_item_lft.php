				...
				<td class="order">
					##codestart## if ($canChange) : ##codeend##
						##codestart## if ($saveOrder) : ##codeend##
							<span>##codestart## echo $this->pagination->orderUpIcon($i, isset($this->ordering[$item->parent_id][$orderkey - 1]), 'categories.orderup', 'JLIB_HTML_MOVE_UP', $ordering); ##codeend##</span>
							<span>##codestart## echo $this->pagination->orderDownIcon($i, $this->pagination->total, isset($this->ordering[$item->parent_id][$orderkey + 1]), 'categories.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ##codeend##</span>
