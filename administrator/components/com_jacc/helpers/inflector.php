 ...
 * Pluralize and singularize English words.
 *
 * InflectorHelper pluralizes and singularizes English nouns.
 * Used by Cake's naming conventions throughout the framework.
 *
 * @package       Cake.Utility
...
/**
 * The initial state of InflectorHelper so reset() works.
 *
 * @var array
 */
...
/**
 * Clears InflectorHelpers inflected value caches. And resets the inflection
 ...
 */
	public static function reset() {
		if (empty(self::$_initialState)) {
			self::$_initialState = get_class_vars('InflectorHelper');
			return;
		}
 ...
 *
 * {{{
 * InflectorHelper::rules('plural', array('/^(inflect)or$/i' => '\1ables'));
 * InflectorHelper::rules('plural', array(
 *     'rules' => array('/^(inflect)ors$/i' => '\1ables'),
 *     'uninflected' => array('dontinflectme'),
 *     'irregular' => array('red' => 'redlings')
 * ));
 * InflectorHelper::rules('transliteration', array('/å/' => 'aa'));
 * }}}
 *
 ...
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::pluralize
 */
 ...
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::singularize
 */
 ...
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::camelize
 */
	public static function camelize($lowerCaseAndUnderscoredWord) {
		if (!($result = self::_cache(__FUNCTION__, $lowerCaseAndUnderscoredWord))) {
			$result = str_replace(' ', '', InflectorHelper::humanize($lowerCaseAndUnderscoredWord));
 ...
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::underscore
 */
 ...
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::humanize
 */
 ...
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::tableize
 */
	public static function tableize($className) {
		if (!($result = self::_cache(__FUNCTION__, $className))) {
			$result = InflectorHelper::pluralize(InflectorHelper::underscore($className));
 ...
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::classify
 */
	public static function classify($tableName) {
		if (!($result = self::_cache(__FUNCTION__, $tableName))) {
			$result = InflectorHelper::camelize(InflectorHelper::singularize($tableName));
 ...
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::variable
 */
	public static function variable($string) {
		if (!($result = self::_cache(__FUNCTION__, $string))) {
			$string2 = InflectorHelper::camelize(InflectorHelper::underscore($string));
 ...
 * @return string
 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/inflector.html#InflectorHelper::slug
 */
